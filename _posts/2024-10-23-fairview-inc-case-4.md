...
Case 4: Employee assignment method — Currently, when Fairview Inc. receives a customer call for its sales or service, it assigns the employee who has not visited a customer for the longest time to service the next incoming customer call. Students are asked to analyze whether the company should consider an alternative assignment method. The case solution is offered in Tableau and is accompanied with how-to videos.

**Suitable courses:** Cost or managerial accounting; Accounting information systems; Auditing; Data analytics

[**Link to download files (requires login)**](https://eyus.sharepoint.com/:f:/r/sites/EYARC/EYARC/Analytics%20mindset/Case%20studies/Fairview%20Inc?csf=1&web=1&e=up9ga1)