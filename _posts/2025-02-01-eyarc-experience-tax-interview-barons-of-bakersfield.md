...
**Learning objectives**
1. Practice interviewing with a tax client to gather relevant tax information
2. Apply the relevant tax laws to accurately calculate the client's Child Tax Credit (CTC), Other Dependent Credit (ODC), American Opportunity Tax Credit (AOTC) and Lifetime Learning Credit (LLC)
