...
Case 1: Extract, transform and load (ETL) — Students are asked to perform transformation procedures on the travel expense transaction data and sales and IT employee data so they can load it into a visualization tool for further analysis. The case solution is offered in Alteryx, and is accompanied with how-to videos.
