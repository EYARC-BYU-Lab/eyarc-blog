...
Case 4: Managerial SQL-This case requires students to write SQL queries to answer nine managerial accounting questions. Students also generate and answer their own questions. The SQL queries are more complex than the basic SQL case and can be categorized as intermediate to difficult. 
