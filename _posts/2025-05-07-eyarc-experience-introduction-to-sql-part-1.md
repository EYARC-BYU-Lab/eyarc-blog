...
**Learning objectives**
1. Understand the purpose and structure of SQL.
2. Learn the foundational SQL commands and clauses of SELECT, FROM, WHERE, GROUP BY, HAVING, and ORDER BY.
3. Retrieve and interpret data using basic SQL queries.
