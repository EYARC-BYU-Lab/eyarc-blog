...
There is an academic paper that describes the development and use of the tool. You can email David Wood at davidwood@byu.edu for a copy of the paper.

[Link to download files (requires login)](https://eyus.sharepoint.com/:f:/r/sites/EYARC/EYARC/Teaching%20Tools/AlteryxEval%20Tool?csf=1&web=1&e=fzfhik)