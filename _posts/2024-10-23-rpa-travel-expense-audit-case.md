...
Note that the EYARC Analytics mindset case study, [Fairview Inc Case 2]({{ '/blog/fairview-inc-case-2/' | relative_url }}). travel expense audit, asks students to perform audit analytics procedures on the data this bot is designed to collect. A demonstration video of this bot is available. This case can be used in addition to (or independently of) this case. 
