...
Case 2: Basic SQL-This case has 20 SQL problems that vary in difficulty. All of the queries are SELECT queries. The initial queries are very basic and then build to more complex queries.
